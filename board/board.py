...
class Board:
    def __init__(self):
        ...
        60, 30, 50, (2, 4, 10, 30, 90, TOP_Y, 250), BROWN_P)
        ...
        140, 70, 100, (10, 20, 50, 150, 450, 625, 750), PINK_P)
        ...
        READING_RAILROAD = Monopoly_Railroad("Reading Railroad", 432, BOTTOM_Y, BLACK_P)
        PENNSYLVANIA_RAILROAD = Monopoly_Railroad("Pennsylvania Railroad", LEFT_X, 430, BLACK_P)
        B_O_RAILROAD = Monopoly_Railroad("B & O Railroad", 432, TOP_Y, BLACK_P)
        SHORT_LINE = Monopoly_Railroad("Short Line Railroad", RIGHT_X, 430, BLACK_P)

        # UTILITIES

        ELECTRIC_COMPANY = Monopoly_Utility("Electric Company", LEFT_X, 578, WHITE_P)
        WATER_WORKS = Monopoly_Utility("Water Works", 585, TOP_Y, WHITE_P)
